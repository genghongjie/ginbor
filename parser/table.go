...
func (t *schema) generateService() error {
	fileName := fmt.Sprintf("service/service_%s.go", t.TableName)
	return parseTemplate("tpl/service.template.tpl", t.OutPackage, fileName, t)
}
